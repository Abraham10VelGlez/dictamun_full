...
function decrypt($string, $key) {
   ...
   for($i=0; $i<strlen($string); $i++) {
      ...
      $result.=$char;
      $result=$result."IGECEM_AVG99";
   }
   return $result;
}

$cadena_desencriptada = decrypt($folio,"IGECEM_IGECEM2");

$vowels1 = array("IGECEM_AVG99");
$onlyconsonants1 = str_replace($vowels1, "dictamunabrhamvelzque_igcm", $cadena_desencriptada );
$vowels1 = array("dictamunabrhamvelzque_igcm");
$folio = str_replace($vowels1, "", $onlyconsonants1 );
...
<h3 style="text-align: center;">DOCUMENTO  VALIDADO POR IGECEM DE <br> ACUSE DE PRESENTACION DEL AVISO DE DICTAMEN SOBRE LA<br>
...
$cadena_encriptada = encrypt($folioCompleto,"_IGECEMAVG");
