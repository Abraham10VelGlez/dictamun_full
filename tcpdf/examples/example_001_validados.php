...
///select nombredoc,comentario from public.listadocumentos_v2 where id_dictamen = 288 and clavecastatral = '0240200801000000' order by nombredoc
...
<h3 style="text-align: center;">DICTAMEN '.$folioPresentacion.' DE LA DETERMINACIÓN DE LA BASE DEL IMPUESTO PREDIAL</h3>
</center>';
...
$pdf->write2DBarcode('www.tcpdf.org', 'QRCODE,M', 165, 75, 25, 25, $style, 'N');
...
<BR>
<center>
<h5 style="text-align: center;font-size: 12px;">INMUEBLE DICTAMINADO</h5>
</center>
<center>';
...
<center>
<h5 style="text-align: center;font-size: 12px;">NOMBRE DE LOS ARCHIVOS RECIBIDOS</h5>
</center>
';
...
<table  border="1" style="text-align: center; font-size: 8px;">
    ...
    <tr bgcolor="#CCCCCC">
        <td style="width:5%;text-align: center ;  ">No.</td>
        <td style="width:18%;text-align: center;  ">Descripción</td>
        <td style="width:18%;text-align: center;  ">Nombre</td>
        <td style="width:59%;text-align: center;  ">Comentario</td>
    </tr>
';
...
$pdf->Output('Dic'.$folio.'IGECEM.pdf', 'I');
