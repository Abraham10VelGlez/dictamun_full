...
74 PlanosdeFactores                                 79
      ...
      if (valuee.orden==10) {
                ...
                if (valuee.observacionRevisor == null) {
                   $("#tipologiass").append('<tr><th style="display:none;">'+valuee.id+'</th><th>T-'+contaTipo+'</th><th>'+valuee.nombredoc+'</th><th>'+comentariosT+'</th><th style="width: 605px;"><a id="descargaTipologia" href="'+ruta+fol2+"/"+clavC+"/"+valuee.nombredoc+'" download="'+valuee.nombredoc+'"><i class="fa fa-download fa-2x"></i></a></th><th><textarea style="width: 300px; height: 50px;" id="comentarioT'+contaTipo+'" placeholder="Agregar Observacion"></textarea></th></tr>');
