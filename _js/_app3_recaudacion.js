...
$(document).ready(function () {	
   ...
   //  $.post("../../../../../acceso",{acceess:43,idI:idI, anio:anioxc},
    //	function(n){
      //   $("#cc").val(n); 
        // folioIn(n);
      var fol = $("#cc").val();
     // fol = n ; 
      var clavC = $("#idInmu").val();   
       ...
       $.post("../../../../../acceso",{acceess:45,clavC:clavC,fol:fol},
    	function(z){       
        console.log(z); 
        var conta=0;
      ...
      var folioCompleto = inicio2+fol+"/"+anio;
      ...
      //Dictamen
      var folioCompleto2 = inicio2+fol+"/"+anio;
          ...
          document.getElementById('alertaa').style.display='block';
             ...
             if (conta == 1 ) {
               ...
               document.getElementById('alertaa').style.display='block';
                    ...
                    document.getElementById('alertaStatusMotivo').append('Por tal motivo a concluido su tramite.');

                     document.getElementById('activararchivoHV').style.display='none';
                      document.getElementById('save_rev').style.display='none';
                      document.getElementById('observacionGral').style.display='none'; 
...
74 PlanosdeFactores                                 79
      ...
      if (valuee.orden==10) {
                ...
                if (valuee.observacionRevisor == null) {
                   $("#tipologiass").append('<tr><th style="display:none;">'+valuee.id+'</th><th>T-'+conta+'</th><th>'+valuee.nombredoc+'</th><th>'+comentariosT+'</th><th style="width: 605px;"><a id="descargaTipologia" href="'+ruta+fol2+"/"+clavC+"/"+valuee.nombredoc+'" download="'+valuee.nombredoc+'"><i class="fa fa-download fa-2x"></i></a></th><th><textarea style="width: 300px; height: 50px;" id="comentarioT'+conta+'" placeholder="Agregar Observacion"></textarea></th></tr>');
