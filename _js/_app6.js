...
$(document).ready(function () {
 ...
 var anioxc = $("#anioDic").val();
      ...
      $.post("../../acceso",{acceess:39,folioD:folioD,clavecatastral:clavecatastral},function(z){
            ...
            // var valor_terre = new Intl.NumberFormat('es-MX').format(valuee.sumavalorterravg);
...
load_valterr_avg($("#gva").val(),$("#idG").val());
