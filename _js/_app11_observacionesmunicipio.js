...
$(document).ready(function () {
	...
	var folio = $("#idG").val();  //clave catastral
  var anio = $("#anioDic").val();
  var clave = $("#cvec").val();
  
	$.post("../../../../../acceso",{ acceess:2,folio:folio,anio:anio,clave:clave},function(zm){
    ...
    if(zm == "0000"){
      ...
      $(zm).each(function(key,valuee){
        ...
        $("#comenMunicipi").val(valuee.obs_municipio); 
      ...
      if (valuee.baldio == 't') { //predio baldio
         ...
         document.getElementById('comboBaldio').style.display='block';
          ...
          $("#Baldio1").css('display','contener'); 
          $("#Baldio2").css('display','contener'); 
          $("#baldioM1").css('display','contener'); 
          $("#baldioM2").css('display','contener'); 
         ...
         document.getElementById('comboConstruido').style.display='block';
          ...
          $("#Construido1").css('display','contener'); 
          $("#Construido2").css('display','contener');
          $("#construccionM1").css('display','contener'); 
          $("#construccionM2").css('display','contener');  
          $("#tipolgis").css('display','contener');
      ...
      load_filesxavg(valuee.folr,$("#idG").val(),valuee.etapa);
        ...
        documentosX(valuee.tipopersona,folio,clave);
...
function documentosX(a,b,c){
    ...
    html =
      ...
      '<td> <i class="fa fa-file fa-2x" style="margin-top: 10px;"></i><br><a id="'+ value.id_docx +'" href=" https://dictamunigecem.edomex.gob.mx/files/documentos/'+ b +'/'+ c +'/'+ value.nombredoc +'">' + value.nombredoc + '</a> </td>';
