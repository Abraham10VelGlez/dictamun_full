...
$(document).ready(function () {
  ...
  $("#saver").click(function(){
    var id_fol = $("#gva").val();
    var valorx = $("#selectetap").val();

    
    var cllv = $("#idG").val();

    if( valorx == '? undefined:undefined ?'){
      document.getElementById('alertaa').style.display='block';
      $("#alertaStatus").html('');
      document.getElementById('alertaStatus').append('Seeleciona una etapa, para poder actualizar este dictamen');
      $("#alertaStatusMotivo").html('');
      document.getElementById('alertaStatusMotivo').append('Por tal motivo  no puedes continuar con el cambio de etapa');
      ...
      //console.log(valorx);
    $.post("../../acceso",{acceess:911923,id_fol:id_fol,valorx:valorx,cllv:cllv},function(z){
      //console.log(z);
      if( z == "100" ){
        console.log(z);
        location.href='../../AIGECEMDTMN/Dictamen_reverch/';
      }else{
        document.getElementById('alertaa').style.display='block';
        $("#alertaStatus").html('');
        ...
        console.log("error de actualizacion de etapa de dictamen");
      }
    });
