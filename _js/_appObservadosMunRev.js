	...
	function tablaInmueblesP(t){
		  ...
		  z="";  
		  	  ...
		  	  $('#table_ususw tbody').on( 'click', 'tr', function () {	 
		           ...
		           $('#tablaxinmueble').html("");  
		            ...
		            z=""; 
		        $.post("../../acceso",{acceess:1,cx:cx,tipo:tipo},function(z){
		        	$('#tablaxinmueble').html("");  
		        	cx=""; c = "", c2="", c3="";
	  ...
	  c= "<table class='table table-striped table-responsive-sm' style='color: black;'><thead><tr><th style='font-weight: bold; color: black; background-color: #d0d8f3;'>Clave catastral</th><th style='font-weight: bold; color: black; background-color: #d0d8f3;'>Estatus</th><th style='font-weight: bold; color: black; background-color: #d0d8f3;'>Contribuyente</th><th style='font-weight: bold; color: black; background-color: #d0d8f3;'>Revisor</th></tr></thead><tbody>";
				 ...
				 $(z).each(function(key,valuee){
				 	...
				 	if (valuee.tipod == 1) {
			 c2= "<tr><td><a href='../SeguimientoComentariosMun/"+valuee.folio+"/"+valuee.cclave+"/"+valuee.aniodictamen+"/"+valuee.tipod+"'>"+valuee.cclave+"</a></td><td>"+valuee.etapadictamen+"</td><td>"+valuee.nombredenominacion+" "+valuee.apaterno+" "+valuee.amaterno+"</td><td>"+valuee.nombre+" "+valuee.ap_paterno+" "+valuee.ap_materno+"</td></tr>"+c2; 

				 	}else if(valuee.tipod == 2){

	 c2= "<tr><td><a href='../SeguimientoComentariosMun/"+valuee.folio+"/"+valuee.cclave+"/"+valuee.aniodictamen+"/"+valuee.tipod+"'>"+valuee.cclave+"</a></td><td>"+valuee.etapadictamen+"</td><td>"+valuee.nombredenominacion+"</td><td>"+valuee.nombre+" "+valuee.ap_paterno+" "+valuee.ap_materno+"</td></tr>"+c2; 
