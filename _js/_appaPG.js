...
//alert("asdasdasd");
		  		...
		  		$scope.pathvector.vector.push({
		  				...
		  				cclave: $(this).parent().parent().find('td').eq(1).html(),
		  				selec: 1		  				
		  			});		
		  	});
		  				console.log('cevtor.....');
		  	...
		  	$("#ordenesOficios").css('display','block');
		    $("#btnasg").css('display','none'); //buton de general
		  var todo = $("#ee").val(); 
		  				$("#foliosT").val(todo); 
	...
	angular.forEach($scope.pathvector.vector, function(inmueble, value) {
							$("#taFolios").append(inmueble.folio + '<tr><td><input type="text" name="f'+inmueble.folio+'" id="f'+inmueble.folio+'" value="'+inmueble.folio+'" style="border: 0;" readonly></td><td><input type="text" name="c'+inmueble.folio+'" id="c'+inmueble.folio+'" value="'+inmueble.cclave+'" style="border: 0;" readonly></td></tr>');
		  	  ...
		  	  console.log("finally finished gists");
		  			...
		  			/*	if(  $("#ee").val() == "0" || $("#ee").val() == null){
							...
							$("#aaa").css('display','block');
		  					...
		  					$("#aaa").css('display','none');
		  					location.href="../../oficiOrdenPagos.php?num=" +   $("#ee").val();
	...
	angular.forEach($scope.pathvector.vector, function(inmueble, value) {
	$("#taFolios").append(inmueble.folio + '<tr><td><input type="text" name="f'+inmueble.folio+'" id="f'+inmueble.folio+'" value="'+inmueble.folio+'" style="border: 0;" readonly></td><td><input type="text" name="ff'+inmueble.folio+'" id="ff'+inmueble.folio+'"></td></tr>');
  ...
  $("#taFolios").append('<tr><td><input type="text" name="f'+value.folio+'" id="f'+value.folio+'" value="'+value.folio+'" style="border: 0;" readonly></td><td><input type="text" name="ff'+value.folio+'" id="ff'+value.folio+'"></td></tr>');
					...
					tabl += '</tbody>'; 
		  				...
		  				console.log('func 3'); 
		 	  				...
		 	  				$("#aaa").css('display','none');
		 	  				/*
		 	  				var totalyFolios=$("#ee").val();
		 	  				var separa = totalyFolios.split("|");
		 	  				var To = separa[0];
		 	  				var folioSe="";
		 	  				var folioSe2="";
		 	  				var solofol="";
							...
							folioSe = $("#f"+i+"").val();
							folioSe2 = $("#ff"+i+"").val();
							solofol = folioSe.split("/");
							foS= solofol[1]; 
							cadeF = foS+"-"+folioSe2+"/"+cadeF
							//console.log(cadeF);				   		 	  					
		 	  				}
		 	  				var todoF= To+"/"+cadeF;
		 	  				console.log(todoF);
...
//alert(t); 
  ...
  c= "<table class='table table-striped table-responsive-sm' style='color: black; '><thead><tr><th style='display: none;'>folio</th><th style='display: none;'>claveCatastral</th><th style='font-weight: bold; color: black; background-color: #d0d8f3;'>Clave catastral</th><th style='font-weight: bold; color: black; background-color: #d0d8f3;'>Estatus</th><th style='font-weight: bold; color: black; background-color: #d0d8f3;'>Contribuyente</th><th style='font-weight: bold; color: black; background-color: #d0d8f3;'>Revisor</th><th style='font-weight: bold; color: black; background-color: #d0d8f3;'>Valor catastral</th><th style='font-weight: bold; color: black; background-color: #d0d8f3;'>Seleccionar</th></tr></thead><tbody>";
			 ...
			 $(z).each(function(key,valuee){
			 	...
			 	if (valuee.tipod == 1) {
		 c2= "<tr><td style='display: none;'>"+valuee.acuse+"</td><td style='display: none;'>"+valuee.cclave+"</td><td><a>"+valuee.cclave+"</a></td><td>"+valuee.etapadictamen+"</td><td>"+valuee.nombredenominacion+" "+valuee.apaterno+" "+valuee.amaterno+"</td><td>"+valuee.nombre_especialista+"</td><td>"+valuee.valor_catastral+"</td><td><input type='checkbox'></td></tr>"+c2; 

			 	}else if(valuee.tipod == 2){

 c2= "<tr><td style='display: none;'>"+valuee.acuse+"</td><td style='display: none;'>"+valuee.cclave+"</td><td><a>"+valuee.cclave+"</a></td><td>"+valuee.etapadictamen+"</td><td>"+valuee.nombredenominacion+"</td><td>"+valuee.nombre_especialista+"</td><td>"+valuee.valor_catastral+"</td><td><input type='checkbox'></td></tr>"+c2; 
