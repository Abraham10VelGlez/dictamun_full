...
<html ng-app="todoApp">
  ...
  <head>
    ...
    <title>Datos Generales del Dictamen</title>
  ...
  <script type="text/javascript" src="<?php echo SERVERURL; ?>_js_revisor/_app3_revhojasno.js"></script>
         ...
         <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a  href="../SeguimientoRevisor/30"  aria-expanded="false"><i
                            ...
                            <div class="card-body">
                                <div id="accordion-seven" class="accordion accordion-header-bg accordion-bordered">
                                    <div class="accordion__item">
                                        <div class="accordion__header collapsed accordion__header--info" style="background-color: #6d7393;" data-toggle="collapse" data-target="#header-bg_collapseOne">
...
<div id="descargarHojasVerdes">
  ...
  <div class="container-fluid">
    <div class="row">
    <div id="activararchivoHV" class="col-md-12" style="">
