...
<head>
    ...
    <title>Dictamenes Autorizados </title>
   ...
   <script type="text/javascript" src="<?php echo SERVERURL; ?>_js/_appAdminPreautorizados.js"></script>
                 ...
                 <div class="alert alert-primary left-icon-big alert-dismissible fade show" style="display: block; border-top: -10px;" id="alertaa">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="mt-1 mb-1" id="alertaStatus">El dictamen pasa a etapa 13 (Rechazado)</h6>
                                                    <p class="mb-2" id="alertaStatusMotivo">En espera a que al administrador pagos continue.</p>
                                                   
                                                </div>
                                            </div>
                                        </div>
                    <?php       }else if($estatus == 7){    ?>
                             ...
                             <div class="alert alert-primary left-icon-big alert-dismissible fade show" style="display: block; border-top: -10px;" id="alertaa">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="mt-1 mb-1" id="alertaStatus">El dictamen pasa a etapa 7 (Liberado)</h6>
                                                    <p class="mb-2" id="alertaStatusMotivo">En espera a que al administrador pagos continue con el proceso.</p>
      ...
      <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-block">
                                <h4 class="card-title">Dictamenes Autorizador por el administrados de pagos.</h4>
...
<tr ng-repeat="x in empList_dtmpen">
           ...
           <!-- <td><a href="../AdminSeguimiento/{{x.claveanio}}">{{x.cve_cat}}</a></td>  -->
            <td><a href="" onclick="tablaInmueblesP(2);" data-toggle="modal" data-target=".bd-example-modal-lg">{{x.etapa_folio_d}}{{x.acuse_recpecion2}}</a></td>
