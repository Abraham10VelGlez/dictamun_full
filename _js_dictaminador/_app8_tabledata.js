(function(angular) {//alert("angular activadoo");
	...
	/*$scope.searchdict = function(){
			...
			if (fechaInicial == "" || fechafinal == "") {
				...
				$("#tblseg3").css('display','none');
				$("#tblseg4").css('display','none');
				//console.log("error");
				...
				//alert(link);
				$http.post('../../acceso2', {
					data: {access: 52,var1:var1,var2:var2,link:link,clasif:clasif}
				}).success(function(response){

                if( response == "000"){
                  $("#tblseg").css('display','block');
                  //$('#sinRegistro').css('display','block');
                  //console.log("sin registros dictamenes pendientes");
                ...
                clasif = 2;
  ////////*********no muestra los dictamenes en estatus 4 ya que estan en revision por parte del igecem, asi evitamos q se modifique informacion //**************///////////
                ...
                //console.log(response);
								$("#tblseg2").css('display','block');
                $scope.lista_aa = response;
                }

                 clasif = 3;
  ////////********* muestra los dictamenes en estatus 15, ya validado su pago //**************///////////
			...
			/*	$http.post('../../acceso2', {
                ...
                if( response == "000"){
                  $("#tblseg3").css('display','block');
                  $('#sinRegistro3').css('display','block');
                ...
                //console.log(response);
								$("#tblseg3").css('display','block');
                $scope.lista_aaa = response;
                }


                clasif = 4;
  ////////********* muestra los dictamenes en estatus 11, ya cancelados //**************///////////
	...
	var dato = "";
	 //para seleccionar una opcion
	    $('#myTabl1e tbody').on( 'click', 'tr', function () {
	            ...
	            dato = $(this).find("td:eq(1)").text();
	            var cx = dato.trim();
	            location.href = "../../pdf/aviso/"+dato.trim();
	            //$(this).removeClass('selected');
	    } );
}
function avisoDP(){
 ...
 c2= "<tr><td>"+valuee.cclave+"</td><td>"+valuee.etapadictamen+"</td><td>"+valuee.nombredenominacion+"</td><td>"+valuee.valor_catastral+"</td></tr>"+c2;
  ...
  c= "<table class='table table-striped table-responsive-sm' style='color: black;'><thead><tr><th style='font-weight: bold; color: black; background-color: #d0d8f3;'>Clave catastral</th><th style='font-weight: bold; color: black; background-color: #d0d8f3;'>Estatus</th><th style='font-weight: bold; color: black; background-color: #d0d8f3;'>Contribuyente</th><th style='font-weight: bold; color: black; background-color: #d0d8f3;'>Valor catastral</th></tr></thead><tbody>";
			 ...
			 $(z).each(function(key,valuee){
			 	...
			 	if (valuee.tipod == 1) {
//c2= "<tr><td><a href='../DictamenesValidados/"+ folio_sinceros + "/" + valuee.cclave + "/" + valuee.aniodictamen + "/" + personat + "'>"+valuee.cclave+"</a></td><td>"+valuee.etapadictamen+"</td><td>"+valuee.nombredenominacion+" "+valuee.apaterno+" "+valuee.amaterno+"</td><td>"+valuee.valor_catastral+"</td></tr>"+c2;

 c2= "<tr><td><a>"+valuee.cclave+"</a></td><td>"+valuee.etapadictamen+"</td><td>"+valuee.nombredenominacion+" "+valuee.apaterno+" "+valuee.amaterno+"</td><td>"+valuee.valor_catastral+"</td></tr>"+c2;

			 	}else if(valuee.tipod == 2){

//c2= "<tr><td><a href='../DictamenesValidados/"+ folio_sinceros + "/" + valuee.cclave + "/" + valuee.aniodictamen + "/" + personat + "'>"+valuee.cclave+"</a></td><td>"+valuee.etapadictamen+"</td><td>"+valuee.nombredenominacion+"</td><td>"+valuee.valor_catastral+"</td></tr>"+c2;

c2= "<tr><td><a>"+valuee.cclave+"</a></td><td>"+valuee.etapadictamen+"</td><td>"+valuee.nombredenominacion+"</td><td>"+valuee.valor_catastral+"</td></tr>"+c2;
