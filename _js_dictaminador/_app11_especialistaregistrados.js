	           ...
	           if( z == "50" ){
                 ...
                 document.getElementById('avg1').style.display='block';
	         	  ...
	         	  $.post("../../../../../acceso",{acceess:3338,
                      ...
                      if( prediobaldiosave == "99991155000" ){
                        let timerInterval
Swal.fire({
  title: ' NO EXISTEN Y NO SE CARGARON CORRECTAMENTE ARCHIVOS .VAL DE DICTAVAL',
  html: 'ESCANEANDO SERVIDOR DE DICTAMUN', icon: 'info',

  timer: 10000,
  timerProgressBar: true,
  didOpen: () => {
    Swal.showLoading()
    const b = Swal.getHtmlContainer().querySelector('b_a')
  ...
  if (result.dismiss === Swal.DismissReason.timer) {
    console.log('ahora a cerrar sitio')
  }
});
				   ...
				   pahtv_t.vector_t.push({
				    ...
				    $.post("../../../../../acceso",{acceess:313,
                      ...
                      document.getElementById('avg1').style.display='block';
                          ...
                          if( saver == "99991155000" ){
                            let timerInterval
    Swal.fire({
	      title: ' NO EXISTEM Y NO SE CARGARON CORRECTAMENTE ARCHIVOS .VAL DE DICTAVAL',
	      html: 'ESCANEANDO SERVIDOR DE DICTAMUN', icon: 'info',
       timer: 10000,
      timerProgressBar: true,
      didOpen: () => {
