<?php include '../web/validateDGF.php';//$url = $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"];$ruta = explode("/", $url);$to=count($ruta);
include '../const.php';
?>
...
<head>
    ...
    <title>Dictamenes Validados</title>
...
<tr ng-repeat="x in empList_dtm">
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <!--  onclick="tablaxinmuebleOcultar();" -->
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal" style="background-color: #414558; border-color: #414558; color: white;">Cerrar</button>
    ...
    <script type="text/javascript" src="<?php echo SERVERURL; ?>_js/_appaDGF.js"></script>
