...
<head>
    ...
    <title>Reasignar Especialista (Dictaminador)</title>
                   ...
                   <section id="main-content">
                        <div class="col-lg-12">
                            ...
                            <div class="card-header d-block">
                                <h4 class="card-title">Reasignar Especialista (Dictaminador)</h4>
                                
                            </div>
                            <div class="card-body">
                                <div id="accordion-seven" class="accordion accordion-header-bg accordion-bordered">
                                  <div class="container-fluid">
                                                <h3 style="text-align: center; font-weight: bold;">Reasignación de Especialista por folio de dictamen</h3><br>
     <center>
       <h5 style="font-weight: bold;">**El folio de dictamen no muestra el estatus del tramite (AD ó DIP) porque dicho cambio se aplica al folio incluyendo todas las claves catastrales que este contenga.**</h5>
     

                    <div class="col-md-4"><br><br><br><h5>Selecciona al nuevo Especialista:</h5><br></div>
       <div id="s" class="col-md-6" style="font-weight: bold;">
       <select id="Rvigcm" name="Rvigcm" class="cm" ng-model="Rvigcm" style="width:400px">      
       </select><br><br>
       </div>
       </center>
...
<th style="display: none;">_</th>
        ...
        <th style="background-color: #d0d8f3;">REASIGNACION</th>              
</tr>
</thead>
<tbody>
<tr ng-repeat="x in empList_dtmpen">
            <td style="display: none;">{{x.folio}}</td> 
            <td style="color: black;">{{x.etapa_folio_d}}{{x.acuse}}</td>    
            ...
            <td style="color: black;">{{x.nombre_especialist}}</td>          
...
<script type="text/javascript" src="<?php echo SERVERURL; ?>_js/_appR.js"></script>
