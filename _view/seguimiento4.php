...
<head>
  ...
  <script type="text/javascript" src="<?php echo SERVERURL; ?>_js/_appa3_exereverse.js"></script>
</head>
                            ...
                            <div class="card-body">
                                <div id="accordion-seven" class="accordion accordion-header-bg accordion-bordered">
                                    <div class="accordion__item">
                                        <div class="accordion__header accordion__header--info collapsed" style="background-color: #6d7393;" data-toggle="collapse" data-target="#header-bg_collapseOne">
      ...
      <br><br>
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                    <br><br><br><br>
                                    <center>
                                  Selecciona una etapa a Actualizar
                                    </center>
                                    <center>
                                      <select class="form-control ng-pristine ng-valid ng-touched" id="selectetap" name="selectetap" ng-model="selectetap">
                ...
                <option value="15">VALIDADO</option>
                                    ...
                                    <br><br>
                                    <center>
                                    <button id="saver" type="button" class="btn btn-success btn-flat btn-addon m-b-10 m-l-5"><i class="ti-exchange-vertical"></i> Actualziar Etapa</button>
                                    </center>
