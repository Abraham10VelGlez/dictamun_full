...
<script type="text/javascript" src="<?php echo SERVERURL; ?>_js/_appaM.js"></script>
 ...
 <form id="myForm">
       <div class="col-md-12 table-responsive">
        <table id="table_dtm" class="table table-striped table-bordered xa" datatable="ng" dt-options="vm.dtOptions" style="text-align: center; color: black;">
<thead>
<tr>
...
<tr ng-repeat="x in empList_dtm">
            ...
            <!-- href="../SeguimientoMunicipio/{{x.claveanio}}" --> 
             <td><a href="" onclick="tablaInmuebles(1)" data-toggle="modal" data-target=".bd-example-modal-lg" style="cursor: pointer;" >{{x.acuse_recpecion2}}</a></td>
            <td>{{x.tipoditc}}</td>
