...
<html ng-app="todoApp">
  ...
  <script type="text/javascript" src="<?php echo SERVERURL; ?>_js/_app3_muni.js"></script>
...
.modal-content {
  ...
  <body>
<input type="hidden" name="cc" id="cc" value="<?php echo $foliosinceros; ?>">
    <input type="hidden" id="idG" name="idG" value="<?php echo $clv;  ?>" /> 
    <input type="hidden" id="anioDic" name="anioDic" value="<?php echo $anio;  ?>" />
<input type="hidden" id="kernel" name="kernel" value="<?php echo $foliodecarpeta; ?>" />
<input type="hidden" name="idInmu" id="idInmu" value="<?php echo $clv; ?>"  >
   <div id="preloader">
        ...
        <div class="header">
          <div class="header-content">
            ...
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <div style="color: black;" class="col-xl-3">Folio del Dictamen:<br>AD/<?php echo $foliodecarpeta; echo "/"; echo $anio; echo "/"; echo $clv;
 ?> <br></div>
               <div class="col-xl-5"><br><br><br><br>
               <div class="alert alert-primary left-icon-big alert-dismissible fade show" style="display: block; border-top: -10px;" id="alertaa">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="mt-1 mb-1" id="alertaStatus"> El dictamen se encuentra en etapa 15 (VALIDADO) </h6>
                                                    <p class="mb-2" id="alertaStatusMotivo">Por tal motivo a terminado el proceso en dictamun ya que su pago fue validado correctamente.</p>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                           <li><a href="../../../../DictGrls/">Validados</a></li>
    ...
    <tbody>      
      ...
      <tr>
        ...
        <td><input type="text" name="contri" id="contri" style="border: 0; background-color: transparent; width: 800px;"></td>
      </tr>
      <tr>
        <td>RFC del Contribuyente:</td>
        <td><input type="text" name="rfcC" id="rfcC" style="border: 0; background-color: transparent; width: 800px;"></td>
      </tr> 
      <tr>
        <td>Clave Catastral:</td>
        <td><input type="text" name="clave" id="clave" style="border: 0; background-color: transparent; width: 800px;"></td>
      </tr>
      <tr>
        <td>Valor Catastral:</td>
        <td>$<input type="text" name="valor" id="valor" style="border: 0; background-color: transparent; width: 800px;"></td>
      </tr>
      <tr>
      ...
      <tr>
        <td>Calle:</td>
        <td><input type="text" name="calle" id="calle" style="border: 0; background-color: transparent; width: 800px;"></td>
      </tr>
      <tr>
        <td>No. Exterior:</td>
      ...
      <tr>
        <td>Colonia:</td>
        <td><input type="text" name="colonia" id="colonia" style="border: 0; background-color: transparent; width: 800px;"></td>
      </tr>
      <tr>
        <td>Municipio:</td>
        <td><input type="text" name="municipio" id="municipio" style="border: 0; background-color: transparent; width: 800px;"></td>
      </tr>
      <tr>
        <td>C.P:</td>
      ...
      <tr>
        <td>Referencias:</td>
        <td><input type="text" name="referencia" id="referencia" style="border: 0; background-color: transparent; width: 800px;"></td>
      </tr>
    </tbody>
  </table>
    ...
    <tbody>      
      ...
      <tr>
        ...
        <td><input type="text" name="dictaminador" id="dictaminador" style="border: 0; background-color: transparent; width: 800px;"></td>
      </tr>
      <tr>
    ...
    <tbody>      
      ...
      <tr>
       ...
       <tr id="nombramientoM" style="">
        ...
        <td><input type="text" name="nombra" id="nombra" style="border: 0; background-color: transparent;"></td>
         <td><input type="text" name="comentaNombra" id="comentaNombra" style="border: 0; background-color: transparent;"></td>
    ...
    <center>
    <div id="descargarHojasVerdes" style="color: black;">
    ...
    <tbody>      
      ...
      <tr>
        <td>Ubicación:</td>
        <td><input type="text" name="ubicacion2" id="ubicacion2" style="width: 950px; border: 0; background-color: transparent;"></td> 

      </tr>
       <tr>
         <td></td>
        <td><input type="text" name="ubicacion3" id="ubicacion3" style="width: 950px; border: 0; background-color: transparent;"></td> 
