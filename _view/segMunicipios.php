...
<head>
 ...
 <input type="hidden" id="idG" name="idG" value="<?php echo $cla;  ?>" />
      ...
      <input type="hidden" id="ffff" name="ffff" value="<?php echo $gvafff;  ?>" /> 
     <div id="preloader">
               ...
               <div class="col-xl-5"><br><br><br><br>
                                        ...
                                        <div class="alert alert-primary left-icon-big alert-dismissible fade show" style="display: none; border-top: -10px;" id="alertaa2">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="mt-1 mb-1">Comentario guardado correctamente</h6>
                                                    <p class="mb-2">Por tal motivo se le mostrará al revisor y al dictaminador</p>
                                        ...
                                        <div class="alert alert-primary left-icon-big alert-dismissible fade show" style="display: none; border-top: -10px;" id="alertaa3">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="mt-1 mb-1">Tuvimos un problema con el registro de su comentario.</h6>
                                                    <p class="mb-2">Volver a intentar.</p>
 ...
 <div class="quixnav">
    ...
    <tbody>      
      ...
      <tr>
        ...
        <td><input type="text" name="rfcD" id="rfcD" style="border: 0; background-color: transparent; width: 800px;"></td>
      </tr> 
      <tr>
      ...
      <tr>
        ...
        <td><input type="text" name="tipoD" id="tipoD" style="border: 0; background-color: transparent; width: 800px;"></td>
      </tr>
      <tr>
   ...
   <thead>
     <tr>
       ...
       <th style="text-align: center;">Comentario del Revisor IGECEM</th>
...
<div class="container-fluid">
  ...
  <table id="tipologias" class="table table-striped" style="display: block; color: black;">
    <thead>
  ...
  <table class="table table-striped" style="display: block; color: black;">
    ...
    <tbody>
        ...
        <td colspan="6"></td>  
                                     ...
                                     <div class="accordion__item" id="obs_general">
                                        <div class="accordion__header collapsed accordion__header--info"  style="background-color: #6d7393;" data-toggle="collapse" data-target="#header-bg_collapsesix">
                                            <span class="accordion__header--icon"></span>
                                            <span class="accordion__header--text">OBSERVACIONES MUNICIPIO</span>
                                            <span class="accordion__header--indicator"></span>
                                        </div>
      ...
      <textarea placeholder="Ingresar Observaciones" id="ObservacionMun" name="ObservacionMun" style="width: 600px; height: 100px;">
        ...
        <button type="button" class="btn" id="" name=""  style="background-color: #414558; color: white; border-color: #414558;" onclick="obsMunicipio();">Registrar</button>
      <br><br><br><br>
      <br><br>
    </center> 
