...
<html ng-app="todoApp">
  ...
  <script type="text/javascript" src="<?php echo SERVERURL; ?>_js/_app3_revhojas.js"></script>
...
<input type="hidden" name="fffavg" id="fffavg" value="<?php echo $ffavg; ?>"  >
   ...
   <div id="preloader">
    ...
    <tbody>
      ...
      <tr id="escrituraOtituloPropiedadM">
      ...
      <tr id="nombramientoM">
        <td>Nombramiento de representante legal.</td>
