                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile" style="color: black;">
                               ESPECIALISTA: <?php echo $_SESSION['usuarioactual']; ?>
            ...
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    <li class="nav-label first" >  <h3 style="color: #ffff;">
                     ...
                     <li><a  href="../SeguimientoDictamen/video"  aria-expanded="false"><i
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <video src="../../manuales/DICTAMINADOR.mp4" style="width: 100%;"  controls poster="igecem.png">
