<?php include '../web/validateDGR.php'; 
...
$id_di=$foliodecarpeta;
$an = $anio;
$an2 = $anio;// año a dictaminar  SegDictamen/2017?1100000000000000
$cla = $clv; //clave catastral
...
<html ng-app="todoApp">
  ...
  <script type="text/javascript" src="<?php echo SERVERURL; ?>_js/_app3_recaudacion.js"></script>
...
<input type="hidden" name="cc" id="cc" value="<?php echo $foliodecarpeta;  ?>">
            ...
            <div class="quixnav-scroll">
                 <ul class="metismenu" id="menu">
                    <li class="nav-label first" >  <h3 style="color: #ffff;">
                     ...
                     <li><a  href="../../../../../../AEDTDGR/InicioDGR/"  aria-expanded="false"><i
    ...
    <tbody>
      ...
      <tr>
        ...
        <td colspan="6"></td>  
                                     ...
                                     <div class="accordion__item" id="observacionGral">
