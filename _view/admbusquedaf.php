  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav"> 
      ...
      <li><p style="margin-top: 10px; margin-right: 15px; color: #E6EAE7;"><?php echo $_SESSION['usuarioactual']; ?> &nbsp; &nbsp;  
        <i style="color: #E6EAE7; cursor: pointer;" class="fa fa-user-times fa-2x" title="Cerrar SesiÃ³n" id="killer"></i>   
        ...
        <div class="col-md-2">
         ...
         <div class="col-md-5">
          Estatus: <select id="stt" name="stt" ng-model="stt"  style="width: 152px; height: 25px; margin-top: 5px;">
              ...
              <option value="12">NO AUTORIZADO</option>
...
<div id="alertb" style="display: none;">
       ...
       <div class="col-md-12 table-responsive">
          <table id="example" class="table table-striped table-bordered xa" datatable="ng" dt-options="vm.dtOptions">  
         <thead>
            <tr>
...
<tbody> 
        <tr ng-repeat="x in tbldictsearx">
            ...
            <td><a href="../AdminSeguimiento/{{x.claveanio}}">{{x.cclave}}</a></td>
...
<script type="text/javascript" src="<?php echo SERVERURL; ?>_js/_appa4.js"></script>
