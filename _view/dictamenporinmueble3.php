  ...
  <div class="container-fluid" >
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
     <ul class="nav navbar-nav">
       ...
       <!-- <li><a  href="../Dictamr/<?php //echo $codigo; ?>" style="font-size: medium;">Aviso Dictamen</a></li> -->   
        
        <li><a  href="../SeguimientoDictamen/<?php echo $codigo; ?> " style="font-size: medium;">Seguimiento Dictamen</a></li>    
      </ul>
