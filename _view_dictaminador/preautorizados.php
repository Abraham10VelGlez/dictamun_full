...
<head>
    ...
    <script type="text/javascript" src="<?php echo SERVERURL; ?>_js_dictaminador/_appreautorizados.js"></script>
      ...
      <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-block">
                                <h4 class="card-title">Lista de dictamenes pendientes (Archivo en hojas verdes)</h4>
                            </div>
                        </div>
      ...
      <div class="col-md-12 table-responsive">
       ...
       <table id="table_ususw" class="table table-striped table-bordered xa" datatable="ng" dt-options="vm.dtOptions">
          ...
          <!--    <th style="text-align: center; background-color: #d0d8f3;">CLAVE CATASTRAL</th> -->
              ...
              <th style="text-align: center; background-color: #d0d8f3;">REVISOR</th>
          ...
          <!--    <td><a href="../DictamenenPreAutorizado/{{x.anio}}?{{x.cclave}}">{{x.cclave}}</a></td> -->
              ...
              <td><a href="" onclick="tablaInmueblesP(7);" data-toggle="modal" data-target=".bd-example-modal-lg" >{{x.etapa_folio_d}}{{x.acuse}}</a></td>

              <td style="color: black;">{{x.anio}}</td>
              <td style="color: black;">{{x.nombre_especialista}}</td>
