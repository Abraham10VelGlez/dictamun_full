...
<head>
    ...
    <script type="text/javascript" src="../../../../../_js/_app11_observacionesmunicipio.js"></script>
...
<body>
  <input type="hidden" id="idG" name="idG" value="<?php echo $foliodecarpeta; ?>" />
      ...
      <div class="header">
        <div class="header-content">
            ...
            <div class="collapse navbar-collapse justify-content-between">
               <div style="color: black;" class="col-xl-3">Folio del Dictamen:<br>DIP/<?php echo $foliosinceros; echo "/"; echo $anio; echo "/"; echo $clv;?> <br></div>
      ...
      <div class="content-body">
        ...
        <div class="col-lg-12 col-sm-12">
         ...
         <div class="col-md-12" id="prediosCla">
          ...
          <div class="col-md-12" style="text-align: center; font-weight: bold; font-size: large; color: black; ">Comentario del municipio<br><br>

            <center>
              <textarea id="comenMunicipi" style="width: 600px;" readonly=""></textarea>
            </center>
            <br><br><br>
          </div>
