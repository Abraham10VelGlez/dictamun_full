...
<head>
    ...
    <script type="text/javascript" src="<?php echo SERVERURL; ?>_js_dictaminador/_app11.js"></script>
    <script type="text/javascript" src="<?php echo SERVERURL; ?>_js_dictaminador/_app12.js"></script>
</head>
