...
where id_dictamen = $fol and clavecastatral = '$claveCat' and orden = 32 order by id
  ...
  public function write_download_comment_municipio($con,$id,$comentario){
    $sql2="UPDATE public.estatusxfolio set obs_municipio = '$comentario' where id = $id;";
    pg_query($con, $sql2);
    echo "100";
...
END) as nombrearchivo
  ...
  order by orden";
    ...
    ava_fp7 as factorrestriccion, b.cclave as clave, ava_porcen
