...
<head>
   ...
   <script type="text/javascript" src="<?php echo SERVERURL; ?>_js/_appafilterrevers.js"></script>
</head>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                            <div class="card-header">
                                    ...
                                    <h3 class="card-title">Regresar de etapa dictamenes presentados</h3>
                                    <br><br>
                            </div>
                        ...
                        <div class="card">
                            <div class="stat-widget-one card-body">
                                ...
                                <div class="stat-content d-inline-block">
                                    <div class=""><a id="searchstts" style="cursor: pointer; color: black; font-weight: bold;">Selecciona Estatus del dictamen<br><br> </a>
                                    </div>
