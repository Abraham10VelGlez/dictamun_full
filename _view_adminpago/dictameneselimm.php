...
<head>
   ...
   <script type="text/javascript" src="<?php echo SERVERURL; ?>_js/_appafilterdelete.js"></script>
</head>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                            <div class="card-header">
                                    ...
                                    <h3 class="card-title">Eliminación de dictamenes</h3>
                                    <br><br>
                            </div>
                        ...
                        <div class="card">
                            <div class="stat-widget-one card-body">
                                <div class="stat-icon d-inline-block">
                                  <a id="searchstts" style="cursor: pointer; color: black; font-weight: bold;">
                                      <i class="ti-back-left text-primary"></i>
                                  </a>
                                </div>
                                <div class="stat-content d-inline-block">
                                    <div class=""><a id="searchstts" style="cursor: pointer; color: black; font-weight: bold;">Filtra dictamenes por Estatus<br><br> </a>
                                    </div>

           <div id="a6" style="display: none;">

         <div class="col-md-12">
             <select class="form-control" id="stt" name="stt" ng-model="stt"  >
       ...
       <div class="col-md-12 table-responsive">
        ...
        <tr ng-repeat="x in tbldictsearx">
          ...
          <td style="display:none;">{{x.folio}}</td>
            <td><a href="" onclick='redirect_finish();'  data-toggle="modal" data-target=".bd-example-modal-lg">{{x.acuse_recpecion2}}</a></td>
