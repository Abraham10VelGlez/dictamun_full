...
<head>
  ...
  <script type="text/javascript" src="<?php echo SERVERURL; ?>_js_contribuyente/main.js"></script>
  <script type="text/javascript" src="<?php echo SERVERURL; ?>_js_contribuyente/_app6.js"></script>
</head>
         ...
         <div class="header">
          <div class="header-content">
            ...
            <div class="collapse navbar-collapse justify-content-between">
              <div style="color: black;" class="col-xl-3">Folio del Dictamen:<br><div id="foldicview"></div></div>
