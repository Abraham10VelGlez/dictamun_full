...
<head>
    ...
    <script type="text/javascript" src="<?php echo SERVERURL; ?>_js_contribuyente/_app4.js"></script>
...
<body ng-app="app8"  ng-controller="ControllerTab8">
    ...
    <div id="main-wrapper">
      ...
      <div class="col-md-12"><br><br> <center><h3 style="text-align: center;">Seguimiento de dictamenes registrados</h3></center>
      <div class="container-fluid">
      <div class="row">
    ...
    <div class="col-sm-4"></div>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn" data-dismiss="modal" onclick="tablaxinmuebleOcultar();" style="background-color: #414558; border-color: #414558; color: white;">Cerrar</button>
      ...
      <tr>
        ...
        <th style="background-color: #d0d8f3; ">RFC contribuyente </th>
        ...
        <tbody style="font-size: small;">
          ...
          <td style="display: none;">{{x.acuse}}</td>
            ...
            <td><a href="" onclick="tablaInmuebles(3);" data-toggle="modal" data-target=".bd-example-modal-lg" >{{x.etapa_folio_d}}{{x.acuse}}</a>
            </td>
    ...
    <input type="text" name="sinRegistro" id="sinRegistro" value="Sin registro de dictamenes registrados" style="border: none; color: #8b4c55; width: 370px; display: none; text-align: center; font-size: large;">
    </center>
    <br><br><br>
    ...
    ***********************************-->
    ...
    <script src="<?php echo SERVERURL; ?>jsvendor/assets/js/lib/bootstrap.min.js"></script><script src="<?php echo SERVERURL; ?>jsvendor/assets/js/scripts.js"></script>
    <!-- scripit init-->
