                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile" style="color: black;">
                              CONTRIBUYENTE: <?php echo $_SESSION['usuarioactual']; ?>
...
/*  Estos estilos solo se aplicaran al fondo de la barra en mozilla */
                                                ...
                                                <div class="col-lg-12 mb-6">
                                                    <div class="form-group">
                                                     ...
                                                     Valor Catastral
                                                         ...
                                                         <input type="text"  name="scrp" id="scrp" ng-model="inmbls.scrp" maxlength="20"  class="form-control" />
                                                ...
                                                <div class="col-lg-12 mb-6">
                                                    <div class="form-group">
                                                     ...
                                                     Valor Catastral
                                                         ...
                                                         <input type="text" onkeyup="validarValorCmodf()" onblur="validarValorCmodf()" name="modfscrp" id="modfscrp" ng-model="inmblsmod.modfscrp" maxlength="20"  class=" form-control ng-pristine ng-valid ng-empty ng-valid-maxlength ng-touched"/>
    ...
    ***********************************-->
    ...
    <script type="text/javascript" src="<?php echo SERVERURL; ?>_js_contribuyente/_app9.js"></script>
    <script type="text/javascript" src="<?php echo SERVERURL; ?>_js_contribuyente/_app10.js"></script>
